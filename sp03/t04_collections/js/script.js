...
function menu(name) {
    let menu = new Map();
    menu.set('Roll Double fish', 150);
    menu.set('Roll Double cheese', 300);
    menu.set('Philadelphia De Luxe with salmon', 500);
    menu.set('Philadelphia De Luxe with tuna', 600);
    menu.set('Philadelphia De Luxe with eel', 100);
    menu.set('Philadelphia with sesame and salmon', 140);
    if (name === 'all') {
        let all = '';
