...
function setFirstName(name) {
    ...
    if (name === undefined) {
        while (firstName.innerText === "" || firstName.innerText === null) {
            firstName.innerText = prompt("What's the FIRST name of your hero?", "1");
...
function setLastName(name) {
    ...
    if (name === undefined) {
        while (lastName.innerText === "" || lastName.innerText === null) {
            lastName.innerText = prompt("What's the LAST name of your hero?", "1");
            let regex = RegExp('^[a-zA-Z]+$');
...
function setAge() {
    ...
    while (age.innerText === "" || age.innerText === null) {
        age.innerText = prompt("What's the age of your hero?", "1");
